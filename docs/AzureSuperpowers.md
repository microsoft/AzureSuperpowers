...
[1.1. Exercise - Setup Az PowerShell
8](#exercise---setup-az-powershell-module)

[1.2. Exercise - Setup Git for Windows
9](#exercise---setup-git-for-windows)

[1.3. Exercise - Setup Visual Studio Code
10](#exercise---setup-visual-studio-code)

[1.4. Exercise - Setup Azure Storage Explorer
11](#exercise---setup-azure-storage-explorer)

[1.5. Exercise - Version Check 12](#_Toc536537003)

[1.6. Troubleshooting 13](#troubleshooting)

[2. Lab - Tools Walkthrough 14](#lab---tools-walkthrough)

[2.1. Exercise - VS Code Interface 15](#exercise---vs-code-interface)

[2.2. Exercise - Clone the Azure Superpowers Repository
19](#exercise---clone-the-azure-superpowers-repository)

[2.3. Exercise - Az Walkthrough 22](#exercise---az-walkthrough)

[2.4. Exercise - Azure Storage Explorer Walkthrough
24](#exercise---azure-storage-explorer-walkthrough)

[2.5. Troubleshooting 26](#troubleshooting-1)

[3. Lab - Azure AD and Service Principals
27](#lab---azure-ad-and-service-principals)

[3.1. Exercise - Create Resource Group using the Portal
29](#exercise---create-resource-group-using-the-portal)

[3.2. Exercise - Create Service Principal using the Portal
30](#exercise---create-service-principal-using-the-portal)

[3.3. Exercise - Grant Rights to a Resource Group using the Portal
31](#exercise---grant-rights-to-a-resource-group-using-the-portal)

[3.4. Exercise - Create Resource Group using PowerShell
32](#exercise---create-resource-group-using-powershell)

[3.5. Exercise - Create Service Principal using PowerShell
34](#exercise---create-service-principal-using-powershell)

[3.6. Exercise - Grant Rights to a Resource Group using PowerShell
35](#exercise---grant-rights-to-a-resource-group-using-powershell)

[3.7. Exercise - Log into Azure as Service Principal
36](#exercise---log-into-azure-as-service-principal)

[3.8. Troubleshooting 38](#troubleshooting-2)

[4. Lab - Basic ARM Templates 39](#lab---basic-arm-templates)

[4.1. Exercise - Deploy a Storage Account using an ARM template and
Azure PowerShell
41](#exercise---deploy-a-storage-account-using-an-arm-template-and-azure-powershell)

[4.2. Exercise - Introduce template parameters and variables
44](#exercise---introduce-template-parameters-and-variables)

[4.3. Troubleshooting 49](#troubleshooting-3)

[5. Lab - Git 50](#lab---azure-devops)

[5.1. Exercise - Git Branch 51](#exercise---git-branch)

[5.2. Exercise - Branch policies 56](#exercise---branch-policies)

[5.3. Exercise - Git commit 59](#exercise---git-commit)

[5.4. Exercise - VS Code Sync 62](#exercise-git-pull-git-push)

[5.5. Troubleshooting 65](#troubleshooting-5)

[6. Lab - Azure DevOps 66](#lab---azure-devops)

[6.1. Exercise - Create new Azure DevOps organization
67](#exercise---create-new-azure-devops-organization)

[6.2. Exercise - Explore Azure DevOps Local Repository
69](#exercise---explore-azure-devops-local-repository)

[6.3. Exercise - Add Contributors to your Project
70](#exercise---add-contributors-to-your-project)

[6.4. Troubleshooting 71](#troubleshooting-4)

[7. Lab - AD Super Lab Deployment 72](#lab---ad-super-lab-deployment)

[7.1. Exercise - Deploy AD Super Lab
73](#exercise---deploy-ad-super-lab)

[7.2. Troubleshooting 75](#troubleshooting-6)

[8. Lab - PowerShell DSC 76](#lab---powershell-dsc)

[8.1. Exercise - Exploring DSC Custom Resources on the Web
79](#exercise---exploring-dsc-custom-resources-on-the-web)

[8.2. Exercise -- Build a new Azure VM and install custom DSC resources
80](#exercise-build-a-new-azure-vm-and-install-custom-dsc-resources)

[8.3. Exercise - Create a DSC Configuration
82](#exercise---create-a-dsc-configuration)

[8.4. Exercise - Test the DSC Configuration Locally
83](#exercise---test-the-dsc-configuration-locally)

[8.5. Exercise - Create an Azure Compatible DSC package (.zip)
84](#exercise---create-an-azure-compatible-dsc-package-.zip)

[8.6. Exercise - Deploy an ARM resource DSC extension
86](#exercise---deploy-an-arm-resource-dsc-extension)

[8.7. Troubleshooting 88](#troubleshooting-7)

[9. Lab - Storage Accounts and SAS Tokens
89](#lab---storage-accounts-and-sas-tokens)

[9.1. Exercise - Create a storage account
90](#exercise---create-a-storage-account)

[9.2. Exercise - Create a blob container
92](#exercise---create-a-blob-container)

[9.3. Exercise - Create Test Files 94](#exercise---create-test-files)

[9.4. Exercise - Upload one text file using the portal
95](#exercise---upload-one-text-file-using-the-portal)

[9.5. Exercise - Upload a File Using Azure Storage Explorer
96](#exercise---upload-a-file-using-azure-storage-explorer)

[9.6. Exercise - Upload one file using PowerShell
97](#exercise---upload-one-file-using-powershell)

[9.7. Troubleshooting 98](#troubleshooting-8)

[10. Lab - ARM Templates (Advanced) 99](#lab---arm-templates-advanced)

[10.1. Exercise - Review an existing Advanced ARM Template
101](#exercise---review-an-existing-advanced-arm-template)

[10.2. Exercise - Edit the existing Advanced ARM Template and deployment
106](#exercise---edit-the-existing-advanced-arm-template-and-deployment)

[10.3. Troubleshooting 107](#troubleshooting-9)

[11. Lab - Azure DevOps Service Connections
108](#lab---azure-devops-service-connections)

[11.1. Exercise - Create a Service Principal
109](#exercise---create-a-service-principal)

[11.2. Exercise - Create a Service Connection in Azure DevOps
110](#exercise---create-a-service-connection-in-azure-devops)

[11.3. Exercise -- Verify Service Connection
112](#exercise-verify-service-connection)
...
116](#exercise---azure-devops-organization)

[12.2. Exercise - Create a new Azure DevOps Project
117](#exercise---create-a-new-azure-devops-project)

[12.3. Exercise - Branches 119](#exercise---branches)

[12.4. Exercise - Branch Policies 120](#exercise---branch-policies-1)

[12.5. Exercise - Download sample code and check files into your
repository
121](#exercise---download-sample-code-and-check-files-into-your-repository)

[12.6. Exercise - Service Principal 123](#exercise---service-principal)

[12.7. Exercise - Create a new Resource Group to contain a storage
account for DSC files
124](#exercise---create-a-new-resource-group-to-contain-a-storage-account-for-dsc-files)

[12.8. Exercise - Create a new storage account for DSC files
125](#exercise---create-a-new-storage-account-for-dsc-files)

[12.9. Exercise - Create two new Resource Groups for your application
deployment
127](#exercise---create-two-new-resource-groups-for-your-application-deployment)

[12.10. Exercise - Grant Service Principal with permissions
128](#exercise---grant-service-principal-with-permissions)

[12.11. Exercise - Service Connection
129](#exercise---service-connection)

[13. Lab - Azure DevOps Build (Continuous Integration -- CI)
130](#exercise---service-connection)

[13.1. Exercise - Setup an Azure DevOps build that uses CI to create DSC
zip files
131](#exercise---setup-an-azure-devops-build-that-uses-ci-to-create-dsc-zip-files)

[14. Lab - Azure DevOps Release (Continuous Deployment -- CD)
134](#lab---azure-devops-release-continuous-deployment-cd)
...
> ![code basics hero](./media/image3.png){width="5.7189457567804025in"
...
2.  Click on the **Clone or download** button
    ...
    ![](./media/image8.png){width="6.5in" height="3.575in"}
...
![](./media/image12.png){width="6.5in" height="5.2652777777777775in"}
...
3.  Select **Repos** on the 'Welcome to the project!' screen
    ...
    ![](./media/image21.png){width="3.1573622047244094in"
...
4.  Notice that VS Code will update at the bottom left of the screen
    ...
    ![](./media/image27.png){width="2.9248950131233595in"
...
2.  Click on the Source Control icon, as indicated in the screenshot
    ...
    ![](./media/image32.png){width="4.3875in"
...
3.  In the Explorer View (Select the File icon in the Activity Bar)
    ...
    ![](./media/image34.png){width="4.390657261592301in"
...
13. On the **Complete pull request** window, **uncheck** the box that
    ...
    ![](./media/image41.png){width="4.47248687664042in"
    height="8.083213035870516in"}
...
![](./media/image45.png){width="5.718698600174978in"
...
3.  Expected output from the commands listed above is shown below:
    ...
    ![](./media/image48.png){width="5.308303805774278in"
    height="5.708695319335083in"}
...
1.  Open Server Manager and turn off Internet Explorer Enhanced Security
    Configuration![](./media/image49.png){width="6.491666666666666in"
...
2.  **Refresh** the files within the **sasexample** storage container
    ...
    ![](./media/image50.png){width="6.5in" height="3.2in"}
...
![](./media/image51.png){width="6.5in" height="2.861111111111111in"}
...
1.  Select the **Repos** tab
    ...
    ![](./media/image52.png){width="6.122463910761155in"
    height="3.439306649168854in"}
...
1.  Click on the **Initialize** button to initialize the repository with
    ...
    ![](./media/image53.png){width="6.497222222222222in"
...
5.  The dev branch of your repository needs to look **EXACTLY** as
    ...
    ![](./media/image54.png){width="2.917465004374453in"
    height="2.768786089238845in"}
...
> ![](./media/image55.png){width="6.5in" height="4.172916666666667in"}
...
4.  Use the following screenshot for reference on desired storage
    ...
    ![](./media/image56.png){width="4.375276684164479in"
    height="4.430435258092738in"}
...
7.  Once your storage account is created, create a new container
    **(Private)** in the blob storage configuration. Name the container
    ...
    ![](./media/image57.png){width="5.4739884076990375in"
    height="4.68798009623797in"}
...
>
> ![](./media/image62.png){width="6.5in" height="3.573611111111111in"}
>
> ![](./media/image63.png){width="6.5in" height="4.311111111111111in"}
...
8.  Under the artifact source type, Build will be selected by default.
    ...
    ![](./media/image64.png){width="6.5in" height="3.640277777777778in"}
...
13. You will need to provide template parameters, which can be supplied
    ...
    ![](./media/image68.png){width="6.5in" height="4.741666666666666in"}
...
14. Return back to the pipeline view, and clone the Dev stage, to create
    ...
    ![](./media/image69.png){width="6.5in" height="2.636111111111111in"}
...
17. Setup Continuous Deployment by setting the Continuous deployment
    ...
    ![](./media/image71.png){width="6.480555555555555in"
    height="2.1430555555555557in"}

18. Enable Pre-deployment conditions on the Prod stage, and set yourself
    as the approver![](./media/image72.png){width="6.5in"
    height="2.6666666666666665in"}

    ![](./media/image73.png){width="6.5in"
